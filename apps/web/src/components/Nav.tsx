...
import { toggleMobileMenuScript, toggleThemeScript } from "../lib/client-scripts";
  ...
  <nav class="sticky top-0 z-50 bg-card/80 backdrop-blur border-b border-border">
    <div class={containerClass}>
      <div class="flex items-center justify-between h-16">
        ...
        >
          <span class="text-primary font-mono text-lg">kpango</span>
        </a>
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            ...
            onclick={toggleMobileMenuScript}
          >
            <MenuIcon />
          </button>
        </div>
