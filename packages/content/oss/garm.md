...
stars: 3
highlight: "Deployed to 1300+ Kubernetes clusters as company-wide SSoT platform. Reduced per-engineer auth implementation from 3 days to 30 minutes."
...
- **Deployment scale**: Deployed to **over 1300 Kubernetes clusters** across LY Corporation as the internal standard platform for SSoT management
