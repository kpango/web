...
stars: 8
highlight: "Handles N-token, access token, and role token retrieval with automatic caching and renewal."
...
- Deployed as part of the Athenz ecosystem across **1300+ Kubernetes clusters** at LY Corporation
