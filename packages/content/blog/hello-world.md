...
description: "Introducing the new kpango.com personal portal built with Hono, HTMX, and Tailwind CSS"
date: "2024-03-30"
...
- **[Hono](https://hono.dev)** — lightweight edge-ready web framework for TypeScript
...
- **[Vercel Edge Functions](https://vercel.com/docs/functions/edge-functions)** — globally distributed, near-zero cold starts
